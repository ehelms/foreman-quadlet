...
def iop_service_ports():
    return {
        ...
        'inventory': '8081',
        'advisor-api': '8000',
        'vulnerability-manager': '8300',
        'vulnerability-taskomatic': '8092',
        'vulnerability-listener': '8087',
        'vulnerability-evaluator-recalc': '8088',
        'vulnerability-evaluator-upload': '8089',
        'vulnerability-grouper-metrics': '8090',
        'vmaas-reposcan': '8003',
        'vmaas-reposcan-metrics': '8091',
        'vmaas-reposcan-private': '10000',
        'vmaas-webapp-go': '8002'
    }
